...
| `443-PROJECTIONS` | canonical Bind package, interface, schema, and platform source files | Bind package owner | migrated canonical package | Installer/platform publication | yes | Phase D443 Bind migration | Canonical Bind source files and package-owned declared platform inputs pass package parity checks; active installed bytes remain an #434 activation concern. |
