...
- `clear`：requirements 完整且 authority/hash current；workflow consumer 暂为现有 `guru-review-contract-wording` route，active-task/standalone caller按其 invocation context恢复合法 progression。
