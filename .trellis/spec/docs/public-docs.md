...
Current knowledge authority is `current-main-0.6.17-guru.57`, inheriting
immutable `.56`; it is not a product release axis. Read the current
`R443-01..08`, `D443-01..07`, and `T443-01..20` delta through the three layer
