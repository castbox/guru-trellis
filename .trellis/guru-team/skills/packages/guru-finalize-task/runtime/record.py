...
def run(package_root:Path,command:dict,argv:list[str])->dict:
 ...
 p.add_argument("--validation",action="append");p.add_argument("--review-input",required=True);p.add_argument("--dry-run",action="store_true")
 o=_o(package_root);return call_owner(o,o.cmd_record_finalization_gate,parse_arguments(p,argv))
