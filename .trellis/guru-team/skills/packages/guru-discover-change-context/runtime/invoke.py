...
def run(package_root:Path,command:dict,argv:list[str])->dict:
 ...
 if exit_id=="blocked":out={"exit_id":"blocked"};schema="public-blocked-output.schema.json"
  ...
  out={"exit_id":"context_ready","handoff_profile":"initial_change_request","handoff_mode":owner["mode"],"handoff_target_locator":transition["target_locator"],"handoff_continuation_id":public["continuation_id"],"transition":transition};schema="public-context-ready-output-2.0.schema.json"
