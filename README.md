...
仍保持 6 Skills / 24 exits；global workflow markers 刻意保持 12/46/27，#119
负责 Finish family 激活。
...
已 active，但 global `ready -> guru-finalize-task` invocation/order 仍由 #119 持有并
fail closed；本次不修改 upstream Finish entry。
