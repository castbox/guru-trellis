...
- `D392-04`：Stage 1 只产生 preparation delivery bytes，并依序进入 Phase 2、Task Commit、
  full-branch review、Publication、Finalizer 与 Merge owners。preparation merge 后丢弃 Stage 1
  review/release evidence，fresh-fetch `origin/main` 建立 Stage 2 exact candidate。
...
identity 为 `architecture-contribution-392-release-v0616-guru1-v1`。它继承
