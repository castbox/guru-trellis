...
| `R338-05` | `D338-04`, `D338-05` | `T338-04`, `T338-05` | #251 bound recovery precedence |
...
`docs/architecture/README.md` / `current-main-0.6.5-guru.42` / `active`。当前 contribution 已由 RDT owner
按 `delta_first` 审查为 task-current；它补充 #338 的任务级 traceability，不改变 shared `.42` identity，
