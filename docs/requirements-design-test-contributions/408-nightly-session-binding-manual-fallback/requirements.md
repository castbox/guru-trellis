...
| R408-03 | 同一明确 session 从 primary 创建 linked task 并返回 primary 后保持 active task | R378-02 的非所属 session 隔离继续有效 |
| R408-04 | 保持旧 lifecycle 与 retired-zero，不新增节点/Skill/exit/recovery artifact | R247-01..10、R329-03..07 |
