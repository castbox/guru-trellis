...
| `TST-032`, `SCN-044` | `REQ-048`, `REQ-049`, `BEH-008`, `BEH-010` | `DES-046` | prepared-state/existing-PR regression plus real Git absent/equal/strict-ancestor acceptance and ahead/diverged/unknown rejection |
