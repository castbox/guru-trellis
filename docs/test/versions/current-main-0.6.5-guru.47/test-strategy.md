...
版本：`current-main-0.6.5-guru.47`；状态：`active`；predecessor：`current-main-0.6.5-guru.46`；source baseline：reviewed #378 contribution + inherited .46 authority；精确 revision 由 containing Git object/tree identity 绑定。
...
promotion 校验三层唯一 .47 导航、完整 .46 历史快照与 R378 -> D378 -> T378 trace；新增 Docs diff 仍需 fresh Phase 2/commit/Branch Review。
