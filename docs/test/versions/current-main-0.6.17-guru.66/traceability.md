...
## #454 C6/C7 Reverse Trace

| Test | Requirements | Design | Evidence boundary |
| --- | --- | --- | --- |
| `T454-C6C7-01` | `R454-C6C7-01` | `D454-C6C7-01` | reviewed create paths and source/scope separation |
| `T454-C6C7-02` | `R454-C6C7-02` | `D454-C6C7-02` | registered checkout and selected-base freshness |
| `T454-C6C7-03` | `R454-C6C7-03..04` | `D454-C6C7-01`, `D454-C6C7-03..04` | disposition, ownership and identity projection |
| `T454-C6C7-04` | `R454-C6C7-05..06` | `D454-C6C7-05..06` | session recovery and activation shared input only |
| `T454-C6C7-05` | `R454-C6C7-07` | `D454-C6C7-07` | six planned IDs; E434 package deferred |
| `T454-C6C7-06` | `R454-C6C7-08` | `D454-C6C7-08` | Phase C subtraction, predecessor remains until E434 |
| `T454-C6C7-07` | `R454-C6C7-09` | `D454-C6C7-08` | focused `125/125`; package `19/20`, managed fixture failed |

来源为 [#454 C6/C7 contribution](../../../requirements-design-test-contributions/454-task-lifecycle-state-model-c6-c7/manifest.yaml)，
状态 `reviewed_promoted`；`.63` 是 immutable predecessor，`.64` 是非激活 successor。promotion-created diff、
D443、D436、E434、#434 activation 与 #410 Release matrix 仍须独立验证。

## #454 D443 Reverse Trace

| Test | Requirements | Design | Evidence boundary |
| --- | --- | --- | --- |
| `T454-D443-01` | `R454-D443-01` | `D454-D443-01` | Fixed Fork schema-2, generation 0, live checkout |
| `T454-D443-02` | `R454-D443-02` | `D454-D443-01..02` | retained old checkout, unique current checkout, pointer-only recovery, zero-write mismatch |
| `T454-D443-03` | `R454-D443-03` | `D454-D443-03` | exit-specific DTO and explicit mode |
| `T454-D443-04` | `R454-D443-04` | `D454-D443-04` | source closure, nonactivated selector and projection |

来源为 [D443 contribution](../../../requirements-design-test-contributions/454-task-lifecycle-d443/manifest.yaml)。
Bind 12/12 与 source check 是提升前 candidate evidence；integration 19/20、installed/platform、
promotion-created diff gates 和完整 Release matrix 不由此表宣称通过。

## #454 D436 Reverse Trace

| Test | Requirements | Design | Evidence boundary |
| --- | --- | --- | --- |
| `T454-D436-01` | `R454-D436-01` | `D454-D436-01` | Completion seven outcomes and current merged lineage |
| `T454-D436-02` | `R454-D436-02` | `D454-D436-02` | Closure action set, no mutation, recovery and external change |
| `T454-D436-03` | `R454-D436-03` | `D454-D436-03` | Finish actual merge, archive, PR-head seal and binding retirement |
| `T454-D436-04` | `R454-D436-04` | `D454-D436-04` | Cleanup normal/manual/handoff, retry and generation guard |
| `T454-D436-05` | `R454-D436-05` | `D454-D436-05` | Reactivate generation, session/source and historical isolation |
| `T454-D436-06` | `R454-D436-06` | `D454-D436-06` | source closure; production activation and matrix deferred |

来源为 [D436 contribution](../../../requirements-design-test-contributions/454-task-lifecycle-d436/manifest.yaml)。
当前表定义验收范围；测试/Phase 2/Branch Review 结果应按最终运行事实报告，不以历史 #436
或 D443 证据代替。E434 installed/platform 与 #410 Release matrix 均独立。
