...
| `TST-036`, `SCN-048` | `REQ-052`, `REQ-055` | `DES-049..050`, `DES-052` | unique active `.42` / superseded `.41` / expected-current checks |
| `TST-037` | `REQ-052..053` | `DES-051` | `.3/.39/CLI 0.6.15` active-surface scan and release-boundary review |
| `TST-038` | `REQ-054` | `DES-049..051` | `.41...42` semantic diff and no-ADR/no-runtime-change review |
| `TST-039`, `SCN-048` | `REQ-053`, `REQ-055` | `DES-049`, `DES-052` | contribution review + serialized owners + post-promotion fresh lifecycle |
