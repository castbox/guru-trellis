...
| `T247-08` | canonical/dogfood/installed/Shared/Codex/Claude/Cursor parity、apply/reapply/update、ownership/drift/sidecar与代表性install/update | 不等于完整Release matrix |
