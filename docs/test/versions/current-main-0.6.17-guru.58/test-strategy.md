...
版本：`current-main-0.6.17-guru.58`；状态：`active`；predecessor：`current-main-0.6.17-guru.57`；source baseline：reviewed #452 contribution + inherited immutable `.57` authority；精确 revision 由 containing Git object/tree identity 绑定。
