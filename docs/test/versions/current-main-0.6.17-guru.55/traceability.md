...
[Requirements trace](../../../requirements/versions/current-main-0.6.17-guru.55/traceability.md) 与
[Design trace](../../../design/versions/current-main-0.6.17-guru.55/traceability.md)。Architecture historical
inheritance 为 `.51` / `superseded`；current public identity 为
[`README.md`](../../../architecture/README.md) / `current-main-0.6.17-guru.55` / `active`，对应
...
Architecture inheritance is `.55/active`; #434 production activation, #436 terminal lifecycle and the complete
