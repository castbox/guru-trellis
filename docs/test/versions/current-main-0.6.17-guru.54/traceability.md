...
[Requirements trace](../../../requirements/versions/current-main-0.6.17-guru.54/traceability.md) 与
[Design trace](../../../design/versions/current-main-0.6.17-guru.54/traceability.md)。Architecture historical
inheritance 为 `.51` / `superseded`；current public identity 为
[`README.md`](../../../architecture/README.md) / `current-main-0.6.17-guru.54` / `active`，对应
