...
当前 authority：[`versions/current-main-0.6.5-guru.39/test-strategy.md`](./versions/current-main-0.6.5-guru.39/test-strategy.md) 与 [`test-plan.md`](./versions/current-main-0.6.5-guru.39/test-plan.md)。`traceability.md` 连接 Requirements、Design、Architecture 和 evidence。
