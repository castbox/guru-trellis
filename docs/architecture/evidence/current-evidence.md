...
| --- | --- | --- | --- |
| `EVD-001` | current source baseline | main `2d34abfc9ea3ef488aedf529e022854050270db7` + #283 architecture convergence task delta（精确 revision 为当前 Git HEAD） | `ARCH-CUR-001..004,006..009` |
...
详见 `docs/test/versions/current-main-0.6.5-guru.38/test-plan.md`。`.37` stable tag、
