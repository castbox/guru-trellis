...
| --- | --- | --- | --- |
| `EVD-001` | current source baseline | main `c2b1784654a95b999bbff71daf1393c22aa01048` + #275 committed task-branch delta（精确 revision 为当前 Git HEAD） | `ARCH-CUR-001..004,006..007` |
