...
版本历史：`current-main-0.6.17-guru.62` 是唯一 active Architecture baseline；`.61` 及更早 identities 保持 immutable superseded history。`.62` 完整继承 `.61`，只吸收 #454 已审查的 C4 branch association、establishment 与 rebind substrate，决策与证据见 `ARCH-CUR-039`、`ARCH-DOM-024`、`ARCH-INT-027`、`ARCH-GAP-011`、`ADR-015`、`EVD-037`。active registry 保持 32 Skills / 142 package exits / 102 commands，并额外保留三个 planned IDs；production business workflow 仍为 22 mandatory invokes / 98 exits。
