...
版本：`current-main-0.6.5-guru.50`；状态：`active`；predecessor：`current-main-0.6.5-guru.49`；source baseline：reviewed #247 contribution `architecture-contribution-247-remove-issue-scope-ledger-v1` + inherited immutable `.49` authority；#305 已确认的 `EVO-001..007` 保持独立 target authority。精确 revision 由包含本 authority 的 Git commit/tree identity 绑定，正文不自引用可变 HEAD。
...
版本历史：`current-main-0.6.5-guru.50` 是唯一 active Architecture baseline；`.49`、`.48`、`.47`、`.46`、`.45`、`.44`、`.43`、`.42`、`.41`、`.40`、`.39`、`.38`、`.37`、`.36` 与 `.35` 是 immutable superseded identities。`.50` 继承 `.49` 的 framework source、release mapping、#329/#378/#240/#348/#332/#376 authority、23 Skills / 97 exits / 78 commands，并提升 #247 的 Issue reference/closure ownership 与 accepted `ADR-009`。current framework source 仍为 `castbox/Trellis@a2003296b4c4ce46c50d72ead3b2ec9c317f69fc`、CLI `0.6.17`、package manager `pnpm@10.32.1`；extension 仍为 `0.6.16-guru.41`。released repository axis `v0.6.16-guru.1` 保持 immutable history，且不包含 #247 candidate。本 promotion 不证明 Publication、push、PR、merge、tag、Release 或 Issue closure；promotion-created diff 必须重新进入 fresh Phase 2、task commit 与独立完整 Branch Review。
