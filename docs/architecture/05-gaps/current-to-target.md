...
| `ARCH-GAP-009` | `.64` 已具备重复Delivery、跨分支事实发现、Publish recovery、resolved-tree reconciliation、五个终态lifecycle owners、task identity session binding，以及 #454 C2/D0/C3/C4/C5/C6/C7 substrate，但production仍是Publication/Finalizer/Merge终态链 | #454 完成 D443/D436 migration 后，由 #434 原子激活 Delivery/lifecycle graph 并退休旧 edges | #435/#436/#443 capability 与 #454 Phase C promotion 已完成；#454 remaining migration、#434 activation 与 Release matrix 仍 `open/unverified` |
