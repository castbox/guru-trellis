...
| `ARCH-GAP-009` | `.63` 已具备重复Delivery、跨分支事实发现、Publish recovery、resolved-tree reconciliation、五个终态lifecycle owners、task identity session binding，以及 #454 C2/D0/C3/C4/C5 substrate，但production仍是Publication/Finalizer/Merge终态链 | #454 完成剩余 C6-C7 与 D443/D436 migration 后，由 #434 原子激活 Delivery/lifecycle graph 并退休旧 edges | #435/#436/#443 capability 与 #454 C2/D0/C3/C4/C5 promotion 已完成；#454 remaining migration、#434 activation 与 Release matrix 仍 `open/unverified` |
...
| `ARCH-GAP-011` | `.63` 已具备 #454 C2 shared lifecycle kernel、D0 stage-evidence correction、C3 checkout acquisition/live resolution/provenance、C4 branch association/establishment/rebind，以及 C5 path-free session/resource ownership/Finish seal/Cleanup resolution substrate | task creation owners、最终 subtraction、D443/D436 migration 与 E434 activation 完整闭合 | C2+D0+C3+C4+C5 子缺口 `closed`；完整 lifecycle GAP `partial/open`，由 #454 C6-C7 与 #434 各自 owner 承接 |
