...
| current release | #392 | 发布 `v0.6.16-guru.1` / extension `0.6.16-guru.41` / CLI `0.6.16`，固定 framework source `castbox/Trellis@ad332e3fe5a19d7274cb03e7c2f3e2128f8de291` | Architecture/RDT `.48` 已绑定 expected `.47` serialized promotion；promotion-created diff 的 fresh Phase 2、task commit 与完整 Branch Review 尚未完成。Publication、merge、exact-candidate matrix、tag、Release、business smoke 与 Issue closure 均为 `unverified` |
