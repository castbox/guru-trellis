...
| Requirement / Behavior | Design | Test / Scenario | Architecture |
| --- | --- | --- | --- |
| `R247-01..02` | `D247-01`, `D247-06` | `T247-01`, `T247-07`, `SCN-090` | `ARCH-CUR-027`, `ARCH-INT-017`, `ARCH-GAP-008`, `EVD-026` |
| `R247-03` | `D247-01` | `T247-02` | `ARCH-CUR-027`, `ARCH-DOM-015` |
| `R247-04` | `D247-02` | `T247-03`, `SCN-087` | `ARCH-GOV-006..009`, `EVD-026` |
| `R247-05..06` | `D247-03..05` | `T247-04`, `SCN-085..087`, `SCN-090` | `ARCH-CUR-027`, `ARCH-DOM-015`, `ARCH-INT-017`, `ARCH-GOV-009`, `ADR-009` |
...
`D247-03..05` / `T247-04` / `SCN-085..087` / `SCN-090` 承接。reviewed promotion来源保留在
`docs/requirements-design-test-contributions/247-remove-issue-scope-ledger/`；`.49` 是 immutable
predecessor，`.50` 是 #247 建立的 immutable superseded authority。promotion-created diff与远端动作仍需各 owner fresh验证。
...
[Requirements](./requirement-main.md)、[Design](../../../design/versions/current-main-0.6.5-guru.51/design-main.md)、
[Test](../../../test/versions/current-main-0.6.5-guru.51/test-strategy.md)；反向索引为同版本
[Design trace](../../../design/versions/current-main-0.6.5-guru.51/traceability.md) 与
[Test trace](../../../test/versions/current-main-0.6.5-guru.51/traceability.md)。
Architecture 继承 [`.51` active](../../../architecture/README.md)，证据见
[Test 计划](../../../test/versions/current-main-0.6.5-guru.51/test-plan.md) 与
