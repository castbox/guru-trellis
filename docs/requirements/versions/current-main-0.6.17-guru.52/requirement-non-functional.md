...
- current ledger writer、reader、precondition、schema registration 与 aggregate DTO consumer为零；历史
...
NFR-001..008、developer/ledger retired-zero、旧 lifecycle 与 23/97/78 graph 完整继承。
...
[Test 计划](../../../test/versions/current-main-0.6.17-guru.52/test-plan.md) 维护。
