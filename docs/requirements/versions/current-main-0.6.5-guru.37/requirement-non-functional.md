...
| current candidate `0.6.5-guru.37` stable release | `unverified`，不得称已发布 | #267 |
| workflow source | `public_plus_local_candidate`；证明 public marketplace + exact local candidate compatibility，不证明 `.37` tag-pinned install | #260 / #267 boundary |
