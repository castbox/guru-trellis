...
版本：`current-main-0.6.5-guru.35`；状态：`superseded`；基线：main `3c0d4a2ffe4799eb67f4c5b1c33d8f8a36f61875`。
...
`source_confirmed`：最新稳定 release 是 `v0.6.5-guru.9`，tag commit `56b5f411e533b200e4d8685ca7a2ffb0c778a7f5`；current main manifest 是 `0.6.5-guru.35`，target/tested Trellis CLI 为 `0.6.5`。current main 是 as-built authority，不是已发布 release。

## 非目标

本 authority 不把未来 Trellis `0.6.15`、replacement release 或完整 release matrix 写成 CURRENT；不定义业务仓库私有 PRD；不把 task archive、PR body 或旧测试摘要当成 current intent。
