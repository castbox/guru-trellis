...
- `RDEC-001`（accepted）：current authority 使用 `current-main-0.6.5-guru.35`，明确区别于 released `v0.6.5-guru.9`。
...
- `RDEC-005`（unverified）：Trellis `0.6.15` 与后续 release 由 #260/#267/#275 的责任门禁决定。
