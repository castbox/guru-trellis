...
版本：`current-main-0.6.5-guru.35`；状态：`superseded`。
...
| replacement release exact candidate | `unverified` | #275 |
| 完整多平台 Throwaway matrix | `unverified` | #260/#267 |
| current main `0.6.5-guru.35` release | `unverified`，不得称已发布 | later release owner |
