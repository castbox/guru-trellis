...
[Test 计划](../../../test/versions/current-main-0.6.17-guru.53/test-plan.md) 维护。
...
input 4.0/gate 7.0、原 mutation path 或 #247 ledger-free/Restore。新增 input 5.0/archived-1.0
的实际定义由 canonical package 持有，见同版本 Design。

继承版本的 pin、graph、矩阵和发布状态只绑定其历史版本；.53 不改变 extension 0.6.17-guru.42、
CLI/core 0.6.17、repository axis v0.6.17-guru.1 或 fixed Fork db4ca1dfbb5abaf9be62b2a01b70dda3f80df0f0。
pre-promotion 证据与未验证项集中见 [Test 计划](../../../test/versions/current-main-0.6.17-guru.53/test-plan.md)；
