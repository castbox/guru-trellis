...
#247 的 ledger-free、closure ownership、原 Merge 四出口和 Restore 行为继续有效，新增复审出口不改变它们。
...
实现见 [D418-01..06](../../../design/versions/current-main-0.6.17-guru.53/design-main.md)，
验收见 [T418-01..14](../../../test/versions/current-main-0.6.17-guru.53/test-strategy.md)，
