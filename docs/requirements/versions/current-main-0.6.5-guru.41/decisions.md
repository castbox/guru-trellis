...
- `RDEC-001`（accepted）：current knowledge authority 使用 `current-main-0.6.5-guru.41`，明确区别于 extension candidate `0.6.5-guru.37` 与已发布 replacement baseline `v0.6.5-guru.10`。
