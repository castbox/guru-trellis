...
`.59` 完整继承 `.58`，吸收 reviewed #454 contribution；RDT 与 Architecture current 均为 `.59/active`。promotion-created diff 必须重新通过 fresh Phase 2、Task Commit、完整 Branch Review 后才能进入 Publication；本文不声明 C3-C7、D443、D436、E434、tag 或 Release 已完成。
