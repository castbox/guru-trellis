...
[Test 计划](../../../test/versions/current-main-0.6.17-guru.54/test-plan.md) 维护。
...
pre-promotion 证据与未验证项集中见 [Test 计划](../../../test/versions/current-main-0.6.17-guru.54/test-plan.md)；
