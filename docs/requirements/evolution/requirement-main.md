...
`current-main-0.6.5-guru.45`，由包含 current locators 的 Git commit/tree identity 绑定；`.43` 增加
...
public graph 收敛为 23 Skills / 97 exits / 77 commands；这些 current additions 均由既有 Evolution route/execution continuity、Architecture-aware
