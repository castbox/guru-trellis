...
| Phase 0 change-context semantic closed loop | #111 | active `guru-discover-change-context`；current-state-first、finish-summary index preview、same-snapshot task-local persistence、external ancestor + independent refresh-receipt verification、Git-trackable task target |
