...
- Issue #144：保留 public Skill interface 1.2 legacy 语义并新增独立 1.3 minimal
  ...
  达到 9 Skills / 35 exits，Stage 0 的 6/24 identity 保持不变。
...
commit、commit self-reentry 三条 edge 使用 target-owned
