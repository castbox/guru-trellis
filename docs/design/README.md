...
唯一 current Design authority：[`versions/current-main-0.6.5-guru.42/design-main.md`](./versions/current-main-0.6.5-guru.42/design-main.md)。版本状态与 source binding 见同目录 `manifest.yaml`；完整 live-derived Skill/exit locator 见 [`capability-inventory.md`](./versions/current-main-0.6.5-guru.42/capability-inventory.md)，引用链见 `traceability.md`，决策见 `decisions.md`。
...
| 状态 | 版本 | Locator |
| --- | --- | --- |
| `active` | `current-main-0.6.5-guru.42` | [`design-main.md`](./versions/current-main-0.6.5-guru.42/design-main.md) |
