...
需求与验收定义分别见 [Requirements](../../../requirements/versions/current-main-0.6.5-guru.51/requirement-main.md)
及 [Test](../../../test/versions/current-main-0.6.5-guru.51/test-strategy.md)。反向索引为
[Requirements trace](../../../requirements/versions/current-main-0.6.5-guru.51/traceability.md) 和
