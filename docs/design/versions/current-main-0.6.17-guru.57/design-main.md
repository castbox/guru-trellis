...
完整继承 immutable `.56` 业务合同，当前增量为 #443；当前 registry 为 32 packages / 142 exits / 102 commands，production workflow 保持 22 mandatory invokes / 98 exits。
...
98 exits。当前 #452 candidate已把声明平台扩展到OpenCode，但该平台扩展仍须在本combined diff上独立验证，
不能倒填为#443 pre-promotion evidence。
