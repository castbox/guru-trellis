...
需求主定义为 [R408-01..08](../../../requirements/versions/current-main-0.6.17-guru.53/requirement-main.md)；
...
`current-main-0.6.17-guru.53` / `active`，引用 `ARCH-CUR-029`、`ARCH-INT-014..016`，
...
需求为 [R418-01..07](../../../requirements/versions/current-main-0.6.17-guru.53/requirement-main.md)，
...
原 profiles、status、review anchors、旧成功/失败出口与 mutation 条件不放宽，#247 ledger-free/Restore 不变。
当前能力表中的总数覆盖新增边；继承 D247/D408 等条目的四出口及 23/97/78 只说明原路径/before-state。
