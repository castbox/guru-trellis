...
需求主定义为 [R408-01..08](../../../requirements/versions/current-main-0.6.17-guru.54/requirement-main.md)；
...
`current-main-0.6.17-guru.54` / `active`，引用 `ARCH-CUR-029`、`ARCH-INT-014..016`，
...
需求为 [R418-01..07](../../../requirements/versions/current-main-0.6.17-guru.54/requirement-main.md)，
