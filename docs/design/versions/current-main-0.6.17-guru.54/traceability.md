...
需求与验收定义分别见 [Requirements](../../../requirements/versions/current-main-0.6.17-guru.54/requirement-main.md)
及 [Test](../../../test/versions/current-main-0.6.17-guru.54/test-strategy.md)。反向索引为
[Requirements trace](../../../requirements/versions/current-main-0.6.17-guru.54/traceability.md) 和
...
[`README.md`](../../../architecture/README.md) / `current-main-0.6.17-guru.54` / `active`；
