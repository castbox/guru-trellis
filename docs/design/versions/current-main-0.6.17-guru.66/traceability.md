...
## #454 D436 Design Trace

`D454-D436-01..06` 对应 [D436 contribution trace](../../../requirements-design-test-contributions/454-task-lifecycle-d436/traceability.md)
中的 `R454-D436-01..06` 与 `T454-D436-01..06`。Architecture refs 为 `ARCH-CUR-043`、
`ARCH-DOM-028`、`ARCH-INT-031`、`ARCH-GAP-011`、`EVD-041`；历史 `D436-*` 不替代
本 successor。五个 package 的 consumer 合同只是 canonical source，E434 才安装 production graph。
