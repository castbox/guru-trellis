...
需求与验收定义分别见 [Requirements](../../../requirements/versions/current-main-0.6.17-guru.55/requirement-main.md)
及 [Test](../../../test/versions/current-main-0.6.17-guru.55/test-strategy.md)。反向索引为
[Requirements trace](../../../requirements/versions/current-main-0.6.17-guru.55/traceability.md) 和
[Test trace](../../../test/versions/current-main-0.6.17-guru.55/traceability.md)。
Architecture historical inheritance：`.51` / `superseded`；current public identity 为
[`README.md`](../../../architecture/README.md) / `current-main-0.6.17-guru.55` / `active`；
...
定义：[Requirements](../../../requirements/versions/current-main-0.6.17-guru.55/requirement-main.md)、
[Design](../../../design/versions/current-main-0.6.17-guru.55/design-main.md)、
[Test](../../../test/versions/current-main-0.6.17-guru.55/test-strategy.md)。
反向索引：[Requirements trace](../../../requirements/versions/current-main-0.6.17-guru.55/traceability.md)、
[Design trace](../../../design/versions/current-main-0.6.17-guru.55/traceability.md)、
[Test trace](../../../test/versions/current-main-0.6.17-guru.55/traceability.md)。
...
`current-main-0.6.17-guru.55` / `active`; `ADR-012` is accepted by the paired Architecture promotion.
