...
需求主定义为 [R408-01..08](../../../requirements/versions/current-main-0.6.17-guru.55/requirement-main.md)；
...
`current-main-0.6.17-guru.55` / `active`，引用 `ARCH-CUR-029`、`ARCH-INT-014..016`，
...
需求为 [R418-01..07](../../../requirements/versions/current-main-0.6.17-guru.55/requirement-main.md)，
...
当前 registry 为 26 packages / 114 exits / 96 commands；production workflow 保持 22 mandatory invokes /
98 exits。完整 Release matrix 保持 `unverified`。
