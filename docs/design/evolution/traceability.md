...
| `EVO-NFR-034` | `EVO-DES-035,043,059,070,072`; positive single/subset/explicit larger-set parity and invalid manifest identity zero-source-checkout/apply/commit/mutation coverage remain inside the existing installed publication fixture | Installed Provenance Publication, Evolution Prerequisite, Projection |
