...
if [[ ! -f "$LAUNCHER" ]]; then echo 'Guru Team Skill packages require the complete Guru Team preset.' >&2; exit 2; fi
source "$LAUNCHER" invoke-guru-execute-task-free-change "$@"
