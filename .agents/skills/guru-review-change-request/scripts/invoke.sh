...
case "$PACKAGE_ROOT" in
  */trellis/skills/guru-team/packages/guru-review-change-request) REPO_ROOT="${PACKAGE_ROOT%/trellis/skills/guru-team/packages/guru-review-change-request}" ;;
...
DISPATCHER="${GURU_TEAM_DISPATCHER:-${REPO_ROOT:?unsupported Skill package root for guru-review-change-request}/.trellis/guru-team/scripts/bash/run-skill-command.sh}"
