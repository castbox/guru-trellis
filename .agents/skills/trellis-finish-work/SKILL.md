...
description: "Wrap up the current session: verify quality gate passed, remind user to commit, archive selected completed tasks, and report their status. Use when done coding and ready to end the session."
---
