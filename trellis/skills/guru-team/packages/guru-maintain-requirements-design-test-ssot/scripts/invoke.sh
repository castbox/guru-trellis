...
if [[ ! -f "$LAUNCHER" ]]; then LAUNCHER="$PACKAGE_SCRIPT_DIR/../../../../runtime/launch.sh"; fi
if [[ ! -f "$LAUNCHER" ]]; then LAUNCHER="$PACKAGE_SCRIPT_DIR/../../../../.trellis/guru-team/runtime/launch.sh"; fi
...
source "$LAUNCHER" invoke-guru-maintain-requirements-design-test-ssot "$@"
