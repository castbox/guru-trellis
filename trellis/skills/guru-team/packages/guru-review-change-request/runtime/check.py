...
from common import check_result,live_issue_source,load,normalize_prerequisites,normalize_target,parse,root,validation_receipt
...
def run(package_root:Path,command:dict,argv:list[str])->dict:
 ...
 return {"status":"passed","skill_id":"guru-review-change-request","typed_exit":value["typed_exit"],"target_identity_sha256":target["identity_sha256"],"target_content_sha256":target["content_sha256"],"linkage_sha256":value["evidence_linkage"]["linkage_sha256"],"facts_sha256":value["facts_sha256"],"validation_receipt":validation_receipt(value)}
