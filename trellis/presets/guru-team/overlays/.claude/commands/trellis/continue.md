...
Do not push the branch, create a PR, or call `publish-pr` from `/trellis:continue`. Publish happens only inside `/trellis:finish-work` after archive and journal succeed.
