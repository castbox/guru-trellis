...
- design.md       - Required Guru Team technical design
- implement.md    - Required Guru Team execution plan
...
def get_implement_context(repo_root: str, task_dir: str) -> str:
    ...
    3. required design.md (Guru Team technical design)
    4. required implement.md (Guru Team execution plan)
    """
    context_parts = []
...
1. **Understand specs** - All dev specs are injected above, understand them
    2. **Understand task artifacts** - Read required requirements, technical design, and execution plan
...
1. **Review changes** - Run `git diff --name-only` to see all changed files
	2. **Verify task artifacts** - Check requirements in required prd.md, design.md, and implement.md
...
- Verify required design.md and implement.md constraints"""
