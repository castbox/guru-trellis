...
| `planning` | `prd.md`, `design.md`, and `implement.md` all present | display links to all three documents, wait for explicit post-planning confirmation, record/check `planning-approval.json`, then run `task.py start` |
