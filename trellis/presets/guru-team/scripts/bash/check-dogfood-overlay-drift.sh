...
Validate the frozen historical ownership identity and the current payload bindings
in the exact reviewed allowlist, then compare canonical Guru Team preset overlays
