...
assert extension["version"] == "0.6.5-guru.33"
...
assert len(api["skill_contracts"]["public_input_schema_ids"]) == 52
assert len(api["skill_contracts"]["typed_output_schema_ids"]) == 73
