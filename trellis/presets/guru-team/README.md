...
example `gh:castbox/guru-trellis/trellis#v0.6.15-guru.5`. The release-facing
target is annotated tag `v0.6.15-guru.5`, extension revision `0.6.15-guru.40`,
...
verified yet; #332 establishes those facts only after a fresh exact candidate
...
`0.6.15-guru.40`，目标 stable source 为 `v0.6.15-guru.5`，并以官方 Trellis CLI
