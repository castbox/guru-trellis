...
稳定安装 source 使用 repo release tag `#v0.6.5-guru.6`，并要求官方 Trellis CLI 安装到
...
`0.6.5-guru.30`。该 tag 只会在 preparation PR 合并且 exact remote candidate 验证通过后创建；
...
当前 canonical extension version `0.6.5-guru.30` 对应上文 pin 的 stable release tag
