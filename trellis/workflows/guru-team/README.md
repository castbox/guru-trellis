...
artifact SHA-256/mode/delete identity 构造 cache entry，candidate self 只用 validated
plan deterministic bytes。真实 hook chain 与 commit 先在 isolated index/detached HEAD
